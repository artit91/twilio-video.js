      ...
      if (description.sdp) {
        ...
        description = {
          ...
          sdp: isChrome && vp8SimulcastRequested
            ? this._setSimulcast(description.sdp.replace(new RegExp('42001f', 'g'), '42e01f'), this._sdpFormat, this._trackIdsToAttributes)
            : description.sdp.replace(new RegExp('42001f', 'g'), '42e01f')
        };
      }
